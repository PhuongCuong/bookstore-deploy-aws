  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          data = _context.sent;
          for (index = 1; index < data['Contents'].length; index++) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          _fileUrl = "https://".concat(bucketName, ".s3.").concat(region, ".amazonaws.com/").concat(uploadParams.Key);
          console.log('Tệp tin đã tồn tại');
          return _context2.abrupt("return", _fileUrl);
        case 11:
          i++;
          _context2.next = 6;
          break;
        ...
        case 16:
          ...
          fileUrl = "https://".concat(bucketName, ".s3.").concat(region, ".amazonaws.com/").concat(uploadParams.Key);
