  ...
  var Book = /*#__PURE__*/function (_Model) {
    ...
    _createClass(Book, null, [{
      ...
      function associate(models) {
        Book.belongsTo(models.nhaxuatban, {
          foreignKey: 'nhaXuatBan',
          targetKey: 'keyMap',
          as: 'nhaxuatbanData'
        });
        Book.belongsTo(models.nhacungcap, {
          foreignKey: 'nhaCungCap',
          targetKey: 'keyMap',
          as: 'nhacungcapData'
        });
        Book.belongsTo(models.theloai, {
          foreignKey: 'theLoai',
          targetKey: 'keyMap',
          as: 'theloaiData'
        });
        Book.belongsTo(models.discount, {
          foreignKey: 'keyMap',
          targetKey: 'maSach',
          as: 'discountData'
        });
        Book.belongsTo(models.BookInfor, {
          foreignKey: 'keyMap',
          targetKey: 'bookId',
          as: 'BookInfoData'
        });
        ...
        Book.hasOne(models.ChitietHoaDon, {
          foreignKey: 'bookId',
          targetKey: 'keyMap',
          as: 'ChiTietHoaDonData'
        });
      }
    }]);
    return Book;
